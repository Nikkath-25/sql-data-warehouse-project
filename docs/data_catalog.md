...
The Gold Layer represents business-level, analytics-ready data.  
It is structured to support reporting and analytical use cases using a Star Schema design.  
...
| customer_number   | NVARCHAR(50)  | Alphanumeric identifier for tracking and referencing the customer.         |
| first_name        | NVARCHAR(50)  | Customer first name.                                                       |
| last_name         | NVARCHAR(50)  | Customer last or family name.                                              |
